...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="#"><img src="assets/img/comfort-logo.png"
                width="100px"></a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/gambar-carousel-1.jpg"
                    class="d-block w-100" alt="gambar-carousel-1">
            ...
            <div class="carousel-item">
                <img src="assets/img/gambar-carousel-2.jpg"
                    class="d-block w-100" alt="gambar-carousel-2">
                <div class="carousel-caption d-none d-md-block">
                    <h5 class="text-2">Men and Women Apparel<br>Get it now and
                        get 25% discount<br><br><a href="#"
                            class="btn btn-outline-dark">Purchase</a></h5>
                </div>
            </div>
            <div class="carousel-item">
                <img src="assets/img/gambar-carousel-3.jpg"
                    class="d-block w-100" alt="gambar-carousel-3">
                <div class="carousel-caption d-none d-md-block">
