...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        <a class="navbar-brand" href="#">Comfort</a>
    ...
    <section class="home">
        <img src="img/3.png" alt="img/2.png" id="bg">
        <img src="img/1.png" alt="img/1.png" id="org">
    ...
    <div class="container">
        <div class="container-box bd-grid" id="Container">
            <div class="container-bg">
                <img src="img/cewe 1.jpg" alt="" class="img-container">
            </div>
        ...
        <div class="container-box">
            <div class="container-bg">
                <img src="img/cowo 1.jpg" alt="" class="img-container">
            </div>
